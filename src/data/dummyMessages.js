...
export const dummyMainFeedMessages = [
    ...
    },
    {
        ...
        user: {
            profile_pic: 'https://pbs.twimg.com/profile_images/1429674450304311298/NGeFmJ0m_400x400.jpg',
            handle: 'CicmilJovan'
        },
        date: '13/01/2022',
        link_url: ''
    ...
    {
        text: `I'm convinced people who have stickers on their laptops are not overthinkers`,
        user: {
            profile_pic: 'https://pbs.twimg.com/profile_images/1458917983305310215/fuS4s6-h_400x400.jpg',
            handle: 'yosracodes'
        },
        date: '13/01/2022',
        img_url: '',
    ...
    {
        text: 'Nah.. will be lazy as hell. I drag myself into coding after 1 hr of doing my routine..',
        user: {
            profile_pic: 'https://pbs.twimg.com/profile_images/1467218932956217345/mANQtTrX_400x400.jpg',
            handle: 'CuriouZmystee'
        },
        date: '13/01/2022',
        img_url: '',
        link_url: ''
    ...
    {
        text: 'Potato chips done manually are arduous. Society has settled for machinery made potato chips.',
        user: {
            profile_pic: 'https://pbs.twimg.com/profile_images/1480959291494387715/eTYYXr-i_400x400.jpg',
            handle: 'JakeJilg'
        },
        date: '13/01/2022',
        img_url: '',
